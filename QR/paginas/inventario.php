<div class="container">
	...
	switch($accion):
		case "listado";
			?>
			<h1 class="m-2 p-2"><font color="white"><font face="impact,arial,verdana">INVENTARIO</font></font></h1>
			<div align="center">
			...
			foreach($u as $r):
				...
				<tr>
					...
					<td bgcolor="white"><img src="img/<?php echo $r['foto'];?>" width="275" height="275"></td>
					<td bgcolor="white">
				...
				<div style="background-color:#babdbe" class="col-sm-6 col-sm-5 p-3 shadow "> 
					<form action="" enctype="multipart/form-data" method="post">
						<div class="form-group ">
							<div align="left">
							<label for="nombre"><font color="#263238">NOMBRE:</font></label></div>
							<input type="text" class="form-control" required name="nombre">
						</div>
						<div class="form-group">
							<div align="left">
							<label for="descripcion"><font color="#263238">DESCRIPCION:</font></label></div>
						...
						<div class="form-group">
							<div align="left">
							<label for="precio"><font color="#263238">PRECIO:</font></label></div>
							<input type="text" class="form-control" required name="precio">
						</div>
						<div class="form-group">
							<div align="left">
							<label for="stock"><font color="#263238">STOCK:</font></label></div>
							<input type="text" class="form-control" required name="stock">
						</div>
						<div class="form-group">
							<div align="left">
							<label for="estado"><font color="#263238">ESTADO:</font></label></div>
